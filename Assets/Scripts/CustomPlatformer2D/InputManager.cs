...
namespace KekeDreamLand
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (GameManager.instance.levelMgr.IsTransition)
            {
                StopBoing();
                return;
            }
        ...
        private void HandleLevelInteraction()
        {
            ...
            {
                GameManager.instance.levelMgr.IsLevelPaused = !GameManager.instance.levelMgr.IsLevelPaused;
                return;
            }
        ...
        {
            if (GameManager.instance.levelMgr.IsLevelFinished)
            {
                if (Input.anyKeyDown)
                {
        ...
        private void ToggleHUD()
        {
            ...
            {
                GameManager.instance.levelMgr.ToggleHUD();
            }
        }
